...
public class Flame extends Object
{
    ...
    public Flame(Vector2 position, State direction)
    {
        ...
        animationHandle.addAnimation(
            ...
            new Animation<TextureRegion>(
                FRAME_TIME,
                atlas.findRegions(State.FLAME_DOWN.getValue())));
        animationHandle.addAnimation(
            State.FLAME_UP.getValue(),
            new Animation<TextureRegion>(FRAME_TIME, atlas.findRegions(State.FLAME_UP.getValue())));
        animationHandle.addAnimation(
            State.FLAME_LEFT.getValue(),
            new Animation<TextureRegion>(
                FRAME_TIME,
                atlas.findRegions(State.FLAME_LEFT.getValue())));
        animationHandle.addAnimation(
            State.FLAME_RIGHT.getValue(),
            new Animation<TextureRegion>(
                FRAME_TIME,
    ...
    public static enum State {
        ...
        public String getValue() { return stateName; }
